...
public class WorkflowEventImpl implements WorkflowEvent, WorkflowDetails, PrefilledWorkflowDetails {
  ...
  public WorkflowEventImpl(String workflowModuleId, List<String> i18nLanguages) {
