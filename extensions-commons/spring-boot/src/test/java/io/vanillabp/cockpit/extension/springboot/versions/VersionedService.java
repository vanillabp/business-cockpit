 ...
 */
@Service
@WorkflowService(workflowAggregateClass = VersionedAggregate.class,
...
public class VersionedService {
  ...
  private final ProcessService<VersionedAggregate> processService;

  public VersionedService(
      final ProcessService<VersionedAggregate> processService) {
   ...
   */
  public ProcessService<VersionedAggregate> processes() {
   ...
   * @return The enriched details
   */
  @UserTaskDetailsProvider(taskDefinition = ESCALATE, version = VersionsApplication.TAG_OF_THE_THIRD)
