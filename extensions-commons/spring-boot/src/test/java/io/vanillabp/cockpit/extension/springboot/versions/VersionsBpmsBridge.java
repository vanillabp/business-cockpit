...
/**
 * The BPMS half of this application, played by the test. It answers about a task and a workflow
 * whatever the reference asked for, and it reports the version the reference carried.
 * <p>
