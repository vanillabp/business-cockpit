...
/**
 * One configuration value which is missing, described the way every startup message reports it:
 * the exact property name, what the cockpit needs it for, and a line to copy into the application's
 * configuration.
 */
