...
public class BpmsApiV1Controller implements BpmsApi {
    ...
    public ResponseEntity<Void> registerWorkflowModule(
        ...
        log.info("Registering workflow module v1.0: {}", event);
    ...
    public ResponseEntity<Void> userTaskCreatedEvent(
        ...
        log.info("Received UserTaskCreatedEvent v1.0: {}", event);
    ...
    public ResponseEntity<Void> userTaskCancelledEvent(
        ...
        log.info("Received UserTaskCancelledEvent v1.0: {}", event);

        if (event == null) {
            throw new IllegalArgumentException("Event cannot be null!");
        }

        taskService.cancelTask(userTaskId, userTask -> mapper.ontoModel(userTask, event));
    ...
    public ResponseEntity<Void> userTaskCompletedEvent(
        ...
        log.info("Received UserTaskCompletedEvent v1.0: {}", event);

        if (event == null) {
            throw new IllegalArgumentException("Event cannot be null!");
        }

        taskService.completeTask(userTaskId, userTask -> mapper.ontoModel(userTask, event));
    ...
    public ResponseEntity<Void> userTaskUpdatedEvent(
        ...
        log.info("Received UserTaskUpdatedEvent v1.0: {}", event);

        if (event == null) {
            throw new IllegalArgumentException("Event cannot be null!");
        }

        taskService.updateTask(userTaskId, usertask -> mapper.ontoModel(usertask, event));
    ...
    public ResponseEntity<Void> workflowCreatedEvent(
        ...
        log.info("Received WorkflowCreatedEvent v1.0: {}", event);
    ...
    public ResponseEntity<Void> workflowCancelledEvent(
        ...
        log.info("Received WorkflowCancelledEvent v1.0: {}", event);

        if (event == null) {
            throw new IllegalArgumentException("Event cannot be null!");
        }

        workflowService.cancelWorkflow(workflowId, workflow -> mapper.ontoModel(workflow, event));
    ...
    public ResponseEntity<Void> workflowUpdatedEvent(
        ...
        log.info("Received WorkflowUpdatedEvent v1.0: {}", event);

        if (event == null) {
            throw new IllegalArgumentException("Event cannot be null!");
        }

        workflowService.updateWorkflow(workflowId, workflow -> mapper.ontoModel(workflow, event));
    ...
    public ResponseEntity<Void> workflowCompletedEvent(
        ...
        log.info("Received WorkflowCompletedEvent v1.0: {}", event);

        workflowService.completeWorkflow(workflowId, workflow -> mapper.ontoModel(workflow, event));
