...
const toLocaleTimeStringWithoutSeconds = (date?: Date | string, language?: string): string | undefined => {
...
const toLocaleDateString = (date?: Date | string, language?: string): string | undefined => {
...
const toLocaleStringWithoutSeconds = (date?: Date | string, language?: string): string | undefined => {
