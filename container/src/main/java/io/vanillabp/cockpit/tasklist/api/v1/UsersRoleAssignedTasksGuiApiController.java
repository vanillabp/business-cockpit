...
/**
 * The list of work which is still free. It holds what the user's groups may take and the user has
 * not claimed yet, together with the tasks addressed to nobody.
 */
